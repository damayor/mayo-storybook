...
const _projectsText: Record<Lang, Record<string, ProjectText>> = {
  en: {
    ...
    frontend: {
      ...
      subtitle:
        'Frontend microservice enabling e-commerce PDPs to interact with 3D apparel and footwear models from any angle.',
    ...
    proptech: {
      ...
      subtitle:
        'Full-stack development for interactive real-estate masterplans — combining advanced visualization with backend microservices that display real-time construction progress and sales data.',
      resume:
        "I have developed the front-end with Javascript, Typescript, ReactJS, CSS and all the needed frameworks for 3D, 360 and media interaction. I've got also a back-end experience like needed servers and the related web hosting requirements.",
    ...
    xr: {
      ...
      subtitle:
        'Delivering innovation to dealerships through mobile and web applications that allow customers to fully customize their vehicles—inside and out.',
  ...
  es: {
    ...
    frontend: {
      ...
      subtitle:
        'Microservicio frontend que permite a los PDPs de e-commerce interactuar con modelos 3D de ropa y calzado desde cualquier ángulo.',
    ...
    proptech: {
      projectPublicTitle: 'PropTech',
      subtitle:
        'Desarrollo full-stack para masterplans inmobiliarios interactivos — combinando visualización avanzada con microservicios backend que muestran el progreso de construcción y datos de ventas en tiempo real.',
      resume:
        'Desarrollé el frontend con JavaScript, TypeScript, ReactJS, CSS y todos los frameworks necesarios para interacción 3D, 360 y multimedia. También cuento con experiencia en backend, servidores y los requisitos de hosting web correspondientes.',
    ...
    xr: {
      ...
      subtitle:
        'Llevando innovación a los concesionarios mediante aplicaciones móviles y web que permiten a los clientes personalizar completamente sus vehículos, por dentro y por fuera.',
  ...
  de: {
    ...
    frontend: {
      ...
      subtitle:
        'Frontend-Microservice, der E-Commerce-PDPs ermöglicht, mit 3D-Bekleidungs- und Schuhmodellen aus jedem Blickwinkel zu interagieren.',
    ...
    proptech: {
      projectPublicTitle: 'PropTech',
      subtitle:
        'Full-Stack-Entwicklung für interaktive Immobilien-Masterpläne — mit fortschrittlicher Visualisierung und Backend-Microservices, die Baufortschritt und Verkaufsdaten in Echtzeit anzeigen.',
      resume:
        'Ich habe das Frontend mit JavaScript, TypeScript, ReactJS, CSS und allen erforderlichen Frameworks für 3D-, 360°- und Medieninteraktion entwickelt. Ich verfüge auch über Backend-Erfahrung mit Servern und den entsprechenden Web-Hosting-Anforderungen.',
    ...
    xr: {
      ...
      subtitle:
        'Innovation in Autohäusern durch mobile und Web-Anwendungen, die Kunden ermöglichen, ihre Fahrzeuge vollständig zu individualisieren — innen und außen.',
...
const _miniProjectsText: Record<Lang, MiniProjectText[]> = {
  en: [
    ...
    },
    {
      ...
      resume:
        'Full-scale serious game combining visual and haptic interaction for immersive training experiences.',
    },
    {
      projectPublicTitle: 'SRE in Backend Orchestrator',
      resume:
        'Improved reliability of the Checkout via observability, alerts, and on-call support, with optimized CI/CD pipelines.',
    },
    {
      projectPublicTitle: 'AR Paintings Experience',
      resume:
        'AR experience that recognizes world-city paintings and reveals cultural elements on your mobile device.',
    },
    {
      projectPublicTitle: 'PDF Curriculum Generator',
      resume:
        'Server-based tool that renders user data into multiple CV designs and exports them as PDF.',
    },
    {
      projectPublicTitle: 'Instructor to Game Devs (UNAL + SENA)',
      resume:
        'Summer course for high-school students covering materials, humanoids, animation, and scripting.',
    },
  ...
  es: [
    ...
    {
      projectPublicTitle: 'SRE en Orquestador Backend',
      resume:
        'Mejoré la confiabilidad del Checkout mediante observabilidad, alertas y soporte on-call, con pipelines de CI/CD optimizados.',
    },
    {
      projectPublicTitle: 'Experiencia AR con Pinturas',
      resume:
        'Experiencia de AR que reconoce pinturas de ciudades del mundo y revela elementos culturales en tu dispositivo móvil.',
    },
    {
      projectPublicTitle: 'Generador de CV en PDF',
      resume:
        'Herramienta basada en servidor que renderiza datos del usuario en múltiples diseños de CV y los exporta como PDF.',
    },
    {
      projectPublicTitle: 'Instructor de Desarrollo de Videojuegos (UNAL + SENA)',
      resume:
        'Curso de verano para estudiantes de bachillerato sobre materiales, humanoides, animación y scripting.',
    },
  ...
  de: [
    ...
    },
    {
      ...
      resume:
        'Serious Game in Originalgröße, das visuelle und haptische Interaktion für immersive Trainingserfahrungen kombiniert.',
    },
    {
      projectPublicTitle: 'SRE im Backend-Orchestrator',
      resume:
        'Verbesserte Checkout-Zuverlässigkeit durch Observability, Alerts und On-Call-Support mit optimierten CI/CD-Pipelines.',
    },
    {
      projectPublicTitle: 'AR-Gemälde-Erlebnis',
      resume:
        'AR-Erfahrung, die Gemälde von Weltstädten erkennt und kulturelle Elemente auf dem Mobilgerät enthüllt.',
    },
    {
      projectPublicTitle: 'PDF-Lebenslauf-Generator',
      resume:
        'Serverbasiertes Tool, das Benutzerdaten in mehrere Lebenslauf-Designs rendert und als PDF exportiert.',
    },
    {
      projectPublicTitle: 'Spieleentwicklungs-Kursleiter (UNAL + SENA)',
      resume:
        'Sommerkurs für Schüler mit Schwerpunkt auf Materialien, Humanoiden, Animation und Scripting.',
    },
...
export const backups: Record<string, Project> = {
  volvo: {
    ...
    projectRealTitle: 'Volvo Customization',
    subtitle:
      'Bring innovation to e-commerce by building a web application that allows customers to personalize their products, and interact with them from different angles.',
  ...
  orthaptica: {
    ...
    projectPublicTitle: 'Immersive Medical Trainer',
    subtitle:
      "One-to-one scale simulators combining visual and haptic interaction. I developed mixed-reality training tools — also known as 'serious games' — to provide immersive learning experiences.",
