...
export const projectsMini = [
  ...
  },
  {
    ...
    description:
      'Immersive training simulator combining visual and haptic interaction for medical procedures.',
    tags: ['vr', 'game'],
  ...
  },
  {
    ...
    description:
      'Augmented reality application for virtual product visualization in retail spaces.',
    tags: ['mobile', 'vr'],
