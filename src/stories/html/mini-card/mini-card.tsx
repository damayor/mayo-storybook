...
export const MiniCard = ({
  ...
  return (
    <div className="group relative w-full h-80 md:h-96 rounded-2xl shadow-xl overflow-hidden border-2 border-gray-200 transition-all duration-300 hover:scale-105 hover:shadow-2xl active:scale-110 active:shadow-2xl cursor-pointer">
      {/* Imagen de fondo */}
      <div
          ...
          <div className="grid grid-cols-[1fr_auto] gap-4 mb-auto">
            ...
            <div className="flex flex-col gap-2 items-center">
              {technologies.map((tech, index) => (
                <div
                  key={index}
                  className="bg-black/40 backdrop-blur-sm rounded-lg p-2 border border-white/20"
                >
                  <Icon size="x-small" technology={tech} />
                </div>
              ))}
            </div>
          </div>
