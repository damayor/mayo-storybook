    ...
    if (contentRef.current) {
      setPointerLeft(
        contentRef.current.offsetLeft +
          (isLeftAnchor ? imgBorderAndPadding : contentRef.current.offsetWidth - imgBorderAndPadding),
      )
        ...
        <>
          ...
          <figure ref={contentRef} className={divBoxClassName}>
            {hotspotData.imageUrl ? (
              <img src={hotspotData.imageUrl} alt='' style={boxStyles.image} className='hotspot-content__image' />
            ) : (
              <div style={boxStyles.image} className='hotspot-content__image hotspot-content__image--default' />
            )}
