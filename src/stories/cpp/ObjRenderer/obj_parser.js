async function Module(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module['locateFile']) {
      return locateFile('obj_parser.wasm');
    }
    return new URL('obj_parser.wasm', import.meta.url).href;
  }
  ...
  function assignWasmExports(wasmExports) {
    ...
    _main = Module['_main'] = wasmExports['C'];
    _malloc = wasmExports['E'];
    _free = wasmExports['F'];
    __emscripten_stack_alloc = wasmExports['G'];
    memory = wasmMemory = wasmExports['z'];
    __indirect_function_table = wasmTable = wasmExports['D'];
  }
  var wasmImports = {
    d: ___cxa_throw,
    q: __abort_js,
